               ...
               <div class="row">
                   ...
                   <div class="col-lg-3 col-md-6">
                       ...
                       <div class="tt-footer-widget">
                           ...
                           <h6 class="text-white">{lang key='footer.address'}</h6>

                           <address class="mt-3" style="max-width: 200px;">

                               	{lang key='footer.location'}

				<br/>
				<br/>

                               	<abbr title="Phone">P: {lang key='footer.phoneno'}</abbr>
                   ...
                   <div class="col-lg-3 col-md-6">
                       ...
                       <div class="tt-footer-widget">
                           ...
                           <h6 class="text-white">{lang key='footer.products'}</h6>
                   ...
                   <div class="col-lg-3 col-md-6">
                       ...
                       <div class="tt-footer-widget">
                           ...
                           <h6 class="text-white">{lang key='footer.services'}</h6>
                   ...
                   <div class="col-lg-3 col-md-6">
                       ...
                       <div class="tt-footer-widget">
                           ...
                           <h6 class="text-white">{lang key='footer.accepted'}</h6>
