...
<div class="card tt-custom-card bg-gray-light mb-4">
    <div class="card-body">
        <form method="post" action="{routePath('user-profile-save')}">
            ...
            <input class="btn btn-primary mr-2" id="btnSaveNameChanges" type="submit" name="save" value="{lang key='clientareasavechanges'}" />
...
<div class="card tt-custom-card bg-gray-light">
    <div class="card-body">
        ...
        <form method="post" action="{routePath('user-profile-email-save')}">
            ...
            <input class="btn btn-primary mr-2" id="btnSaveEmailChanges" type="submit" name="save" value="{lang key='clientareasavechanges'}" />
            <input class="btn btn-default" type="reset" value="{lang key='cancel'}" />
        </form>
